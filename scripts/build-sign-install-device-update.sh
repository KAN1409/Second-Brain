...
SIGNED_APK="${SECOND_BRAIN_DEVICE_APK:-/sdcard/Download/Cortex-Relay-v2.0.0-candidate3-permanent.apk}"
...
echo
echo "==> Build 2/5: Cortex Relay v2.0.0 candidate3 combined release"
cd "$ROOT_DIR"
./gradlew \
...
TMP_REMOTE="/data/local/tmp/Cortex-Relay-v2.0.0-candidate3-permanent.apk"
...
echo "APK: $SIGNED_APK"
echo
echo "CORTEX_RELAY_V2_CANDIDATE3_UPDATE_SUCCESS"
